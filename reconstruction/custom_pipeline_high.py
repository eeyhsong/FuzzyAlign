...
if __name__ == "__main__":
    ...
    image_embeds = torch.from_numpy(np.load('./data/TVSD/DNN_feature_maps/clip_h14/clip_h14_feats_test.npy', allow_pickle=True))
    image_embeds = F.normalize(image_embeds, p=2, dim=-1)
    
    print('The shape of image_embeds is:', image_embeds.shape)
    image_embeds = image_embeds[0]
    print('The shape of image_embeds is:', image_embeds.shape)
    image = generator.generate(image_embeds=image_embeds)
    image.save('./spike_SDXL_generation_normalize.png')
