...
def main():
    ...
    parser.add_argument('--val', default='wo_prior', type=str)
    ...
    csv_path = f"{out_dir}/recon_metrics_mean_std_{args.sub}.csv"
    ...
    svg_path = f"{out_dir}/reconstruction_comparison_{args.sub}.svg"
